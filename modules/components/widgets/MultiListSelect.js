...
export default class MultiSelectWidget extends Component {
  ...
  onPropsChanged (props) {
    ...
    map(this.props.listEntries, (listName) => {
      optionsMaxWidth = Math.max(optionsMaxWidth, calcTextWidth(listName, '14px'));
    });
  ...
  render() {
    ...
    const options = map(this.props.listEntries, (listName) => {
